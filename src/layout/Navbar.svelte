<script>
  ...
  function openLoadFolderDialog(e) {
  ...
  <div class="navbar-menu">
    <div class="navbar-start">
      ...
      <div class="navbar-item has-dropdown is-hoverable"
         on:mouseover={() => (menuOpen=true)} on:mouseout={() => (menuOpen=false)} class:is-active={menuOpen}>
...
<FileListing bind:fileListing={fileListing} on:load={loadFolder} />
